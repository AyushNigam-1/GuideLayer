...
export default function Signup() {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-gray-900 space-y-3 dark:text-white flex flex-col p-3 min-w-[300px]">
            ...
            <div className=" text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">
                    Signup to create your tour
                </p>
            </div>

            <div className="flex-1 mt-4 px-2 flex flex-col justify-center">
                <button
